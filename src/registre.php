...
<body>
	...
	<form action="registre.php" method="POST">
		<p>
			<label>Nom del nou gestor o usuari:</label>
			<input type="text" name="nom_nou_usuari" required>
		</p>
		<p>
			<label>Contrasenya del nou gestor o usuari:</label>
		...
		<input type="radio" name="tipus_nou_usuari" value=<?php echo GESTOR ?>>Gestor de l'aplicació<br>
		<input type="radio" name="tipus_nou_usuari" value=<?php echo USR ?>>Usuari de l'aplicació<br>
		<br>
